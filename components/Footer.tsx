import { RiTwitterXFill, RiGithubFill, RiMediumFill } from "react-icons/ri"

export default function Footer() {
    return (
        <>
            <div className="divider"></div>
            <footer className="footer footer-center pb-5">
                <aside>
                    ...
                    <p className="font-bold">
                        PassFin <br />Providing reliable tech since 2023
                    </p>
                    <p>Copyright © 2023 - All right reserved</p>
                </aside>
                <nav>
                    <div className="grid grid-flow-col gap-4">
                        <a className="cursor-pointer hover:text-gray-200 transition" target="_blank" href="https://twitter.com/HeroCodes404">
                            <RiTwitterXFill className="text-2xl" />
                        </a>
                        <a className="cursor-pointer hover:text-gray-200 transition" target="_blank" href="https://github.com/Hero-Codes">
                            <RiGithubFill className="text-2xl" />
                        </a>
                        <a className="cursor-pointer hover:text-gray-200 transition" target="_blank" href="https://medium.com/@herocodes">
